...
Diffusion Monte Carlo (DMC) is a way to solve the time-dependent Schrodinger equation (TDSE)\
 using Monte Carlo sampling of a potential energy surface.  The way we will do this is by representing our wavefunciton as an ensemble of localized functions, or "Walkers", each of which represents a configuration of the molecule/system of interest.
