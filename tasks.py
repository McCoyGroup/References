"""
Taken from https://github.com/jupyterlab/jupyterlab-demo/blob/master/tasks.py
It seems to be required by JupyterLab for config purposes
"""
...
ns = Collection(environment, build, r, clean)
ns.configure({
    'run': {
