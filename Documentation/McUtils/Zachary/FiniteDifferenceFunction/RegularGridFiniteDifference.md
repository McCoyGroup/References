## <a id="McUtils.Zachary.FiniteDifferenceFunction.RegularGridFiniteDifference">RegularGridFiniteDifference</a>
...
```
<a id="McUtils.Zachary.FiniteDifferenceFunction.RegularGridFiniteDifference.__init__">&nbsp;</a>
```python
...
<a id="McUtils.Zachary.FiniteDifferenceFunction.RegularGridFiniteDifference.get_weights">&nbsp;</a>
```python
get_weights(m, s, n): 
```
